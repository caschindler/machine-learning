...
# ESTIMATE CONDITIIONAL PROBABILITY WITH LINK FUNCTION
# Produces probablistic estimate for P(y_i = +1 | x_i, w) and estimate ranges between 0 and 1.
...
# PREDICT SENTIMENT AND MEASURE ACCURACY
scores = np.dot(feature_matrix, coefficients)
...
# IDENTIFYING WORDS THAT CONTRIBUTE MOST TO POSITIVE AND NEGATIVE SENTIMENT
